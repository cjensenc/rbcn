...
theta=1.5 %1.5 Frisch elast = 1/(theta-1), 1.25-2.25 since otherwise makes MU leisure non-decreasing in leisure
%sdzsteps=4
%sdzstep=.04/sdzsteps; %.005
sigmavect=[20; 15; 10; 5; 4; 3; 2; 1.01; .5; 0]; %[4; 3; 2; 1.01; .5; 0] CHANGE FIG LABELS IF CHANGE, [4, 3, 2, 1.01, .5, 0] % sigma can't equal 1
% labels={[char(949) '=4']; [char(949) '=3']; [char(u949) '=2']; [char(949)
% '=1']; [char(949) '=.5']; [char(949) '=0']};gfvvç
...
gp=4000 % 8000 even number of gridpoints k-vector
...
GBRAMreq=2*(gp^2*gpz+4*gp*gpz+gpz^2)*8/1024^3 % 8 bit with double precision
...
for csigma=1:lsigmavect
    for csdz=1:lsdzvect
        ...
        N(1,csdz,csigma)=Nn(1,sub2ind(iterations,csdz,csigma));
...
clear S_KTILDEZ0n S_CZ0n S_VZ0n S_KMAXn S_KBARn S_KSDn S_KSSMn S_KSSNOn S_CBARn S_CSDn S_IBARn S_ISDn S_YBARn S_YSDn S_V1n S_V2n S_V3n S_V4n S_ITERn S_TRASHITn S_TRASHMAXn Vn Ktildepositionn Ktilden Nn Cn Zn S_KMINn S_SDZn S_SIGMAn

tv = datetime('now', 'Format','yyyy_MM_dd_HH_mm');
filename = sprintf('GRiskGHH4RCNfix_%s.mat',tv);
