...
load GRiskGHH4RCNfoc_2024_12_05_15_55-8k51hp.mat
sigmavect'
alpha
beta
delta
...
plot(S_SDZ(:,:,1), 1.3856*ones(2),'color',[.5 .5 .5],'LineStyle',':');
axis([-.0005 .0315 -.03 2]);
ytickformat('%.1f')
xlabel('\sigma','FontSize',fontS+2);
fontsize(gca,fontS,"points")
centeraxes(gca);
lgd=legend(labels,'Position',[.38 .15 .06 .4],'FontSize',fontS)
title(lgd,'SSRRAC','FontSize',fontS,'FontWeight','normal');
...
plot(S_SDZ(:,:,i), 2.0873*ones(2),'color',[.5 .5 .5],'LineStyle',':');
axis([-.0005 .0315 -.03 2.5]);
ytickformat('%.1f')
xlabel('\sigma','FontSize',fontS+2);
fontsize(gca,fontS,"points")
centeraxes(gca);
lgd=legend(labels,'Position',[.81 .15 .06 .4],'FontSize',fontS)
title(lgd,'SSRRAC','FontSize',fontS,'FontWeight','normal');
title('SD hours','Interpreter','Latex','FontSize',fontS+4);
hold off;
exportgraphics(gcf,"GRiskRBCnGHHNfocFIGHP.eps","Resolution",300)
...
plot(S_SDZ(:,:,i), 1.6443*ones(2),'color',[.5 .5 .5],'LineStyle',':');
axis([-.0005 .0315 -.04 3.1]);
ytickformat('%.1f')
xlabel('\sigma','FontSize',fontS+2);
fontsize(gca,fontS,"points")
centeraxes(gca);
lgd=legend(labels,'Position',[.75 .35 .01 .1],'FontSize',fontS)
title(lgd,'SSRRAC','FontSize',fontS,'FontWeight','normal');
title('SD GDP','Interpreter','Latex','FontSize',fontS+4);
hold off;
exportgraphics(gcf,"GRiskRBCnGHHNfocFIGHPy.eps","Resolution",300)
