...
load GRiskADSeNfoc_2025_01_15_22_35-4k51shp.mat
sigmavect'
alpha
beta
delta
...
labels1={['20']; ['15']; ['10']; ['5']};
lsigmavect1=length(sigmavect1);
lsdzvect1=lsdzvect;


load GRiskADSeNfoc_2024_12_01_16_49-4k51hp.mat
sigmavect'
alpha
beta
delta
...
S_SDZ2=S_SDZ;
S_CSDCOMPDATA2=S_CSDCOMPDATA;
S_NSDCOMPDATA2=S_NSDCOMPDATA;
S_YSDCOMPDATA2=S_YSDCOMPDATA;
...
hold on;
for i=1:lsigmavect1
    plot(S_SDZ1(:,2:5,i), S_CSDCOMPDATA1(:,2:5,i), 'color',colors1{i,1},'linewidth',1.5);
end
for i=1:lsigmavect2
    plot(S_SDZ2(:,2:5,i), S_CSDCOMPDATA2(:,2:5,i), 'color',colors2{i,1},'linewidth',1.5);
end
...
centeraxes(gca);
lgd=legend(labels,'Position',[.12+.01 .5-.1 .055 .42],'FontSize',fontS)
...
hold on;
for i=1:lsigmavect1
    plot(S_SDZ1(:,2:5,i), S_NSDCOMPDATA1(:,2:5,i), 'color',colors1{i,1},'linewidth',1.5);
end
for i=1:lsigmavect2
    plot(S_SDZ2(:,2:5,i), S_NSDCOMPDATA2(:,2:5,i), 'color',colors2{i,1},'linewidth',1.5);
end
...
fontsize(gca,fontS,"points")
centeraxes(gca);
lgd=legend(labels,'Position',[.55 .5 .055 .42],'FontSize',fontS);
title(lgd,'RRAC','FontSize',fontS,'FontWeight','normal');
title('SD hours','Interpreter','Latex','FontSize',fontS+4);
hold off;
exportgraphics(gcf,"GRiskRBCnADSeNfocFIGHP.eps","Resolution",300)


figure;
hold on;
for i=1:lsigmavect1
    plot(S_SDZ1(:,2:5,i), S_YSDCOMPDATA1(:,2:5,i), 'color',colors1{i,1},'linewidth',1.5);
end
for i=1:lsigmavect2
    plot(S_SDZ2(:,2:5,i), S_YSDCOMPDATA2(:,2:5,i), 'color',colors2{i,1},'linewidth',1.5);
end
plot(S_SDZ(:,:,i), 1.6443*ones(lsdzvect),'color',[.5 .5 .5],'LineStyle',':');
axis([-.0015 .1454 -.15 14.5]);
%ytickformat('%.1f')
xlabel('\sigma','FontSize',fontS+2);
fontsize(gca,fontS,"points")
centeraxes(gca);
lgd=legend(labels,'Position',[.2 .6+.02 .03 .1],'FontSize',fontS);
title(lgd,'RRAC','FontSize',fontS,'FontWeight','normal');
title('SD GDP','Interpreter','Latex','FontSize',fontS+4);
hold off;
exportgraphics(gcf,"GRiskRBCnADSeNfocFIGHPy.eps","Resolution",300)
...
% hold off;
% exportgraphics(gcf,"GRiskRBCnADSeNfocFIGstats.eps","Resolution",300)
% 
% 
% 
% 
