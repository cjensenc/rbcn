function [ktildez0,cz0,vz0,kmax,kbar,ksd,kssM,kssno,cbar,csd,ibar,isd,ybar,ysd,v1,v2,v3,v4,iter,trashit,trashmax,v,ktildeposition,ktilde,n,c,z,kmin,sigma,sdz] = GRiskGHH2RCNfixfun(sdz,sigma,A,alpha,rho,beta,mu,delta,theta,psi,gp,gpz,T,Ti,itermax,k,v,UsekssTh,kssTh,countsdz,Reps,nssTh)
...
for i=1:gp
    for m=1:gpz
        ...
        for j=1:gp
            ...
            u0=((cc-psi*(n^theta)/theta)^(1-sigma)-1)/(1-sigma);
            ...
            if sigma == 0
                ...
                if cc >= 0 && isreal(u0) && cc-psi*(n^theta)/theta > 0
                    U0(i,j,m)=u0;
                else
                    U0(i,j,m)=-inf;
                end
